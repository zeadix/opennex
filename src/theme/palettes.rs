...
pub fn templates() -> [TerminalPaletteTemplate; 5] {
    [
        TerminalPaletteTemplate { id: "one-dark", name: "One Dark" },
        TerminalPaletteTemplate { id: "solarized-dark", name: "Solarized Dark" },
        TerminalPaletteTemplate { id: "gruvbox-dark", name: "Gruvbox Dark" },
        TerminalPaletteTemplate { id: "dracula", name: "Dracula" },
        TerminalPaletteTemplate { id: "opennex-light-terminal", name: "OpenNex Light Terminal" },
    ]
}
...
fn config(
    fg: &str, bg: &str,
    normal: AnsiColors, bright: AnsiColors, dim: AnsiColors,
    dim_fg: &str, cursor: &str, sel_bg: &str, sel_text: &str, link: &str,
) -> TerminalThemeConfig {
    TerminalThemeConfig {
        foreground: rgb(fg),
        background: rgb(bg),
...
fn one_dark() -> TerminalThemeConfig {
    config(
        ...
        ansi("#5c6370", "#e06c75", "#98c379", "#e5c07b", "#61afef", "#c678dd", "#56b6c2", "#ffffff"),
        ansi("#1c2026", "#9c4f56", "#6c8f57", "#a6895a", "#477cab", "#8d559d", "#3d828a", "#757b85"),
        "#6b7280", "#2cbfae", "#333840", "#e6e9ed", "#61afef",
    )
}
...
fn solarized_dark() -> TerminalThemeConfig {
    config(
        ...
        ansi("#586e75", "#cb4b16", "#859900", "#b58900", "#268bd2", "#d33682", "#2aa198", "#fdf6e3"),
        ansi("#053440", "#a22824", "#667600", "#886800", "#1d6a9c", "#a02963", "#207a72", "#b6b3a6"),
        "#657b83", "#268bd2", "#185d6f", "#eee8d5", "#2aa198",
    )
}
...
fn gruvbox_dark() -> TerminalThemeConfig {
    config(
        ...
        ansi("#928374", "#fb4934", "#b8bb26", "#fabd2f", "#83a598", "#d3869b", "#8ec07c", "#ebdbb2"),
        ansi("#1d2021", "#9d1a15", "#7a7014", "#a77619", "#36656a", "#894a69", "#4f7452", "#837768"),
        "#a89984", "#fabd2f", "#504945", "#ebdbb2", "#83a598",
    )
}
...
fn dracula() -> TerminalThemeConfig {
    config(
        ...
        ansi("#6272a4", "#ff6e6e", "#69ff94", "#ffffa5", "#d6acff", "#ff92df", "#a4ffff", "#ffffff"),
        ansi("#1a1c24", "#bf4040", "#3cbb5d", "#b4bc69", "#8d6ebb", "#bf5a95", "#68aebe", "#bbbbbb"),
        "#9a9a9a", "#bd93f9", "#44475a", "#f8f8f2", "#8be9fd",
    )
}
...
fn opennex_light_terminal() -> TerminalThemeConfig {
    config(
        ...
        ansi("#586e75", "#cb4b16", "#859900", "#b58900", "#268bd2", "#d33682", "#2aa198", "#fdf6e3"),
        ansi("#053440", "#a22824", "#667600", "#886800", "#1d6a9c", "#a02963", "#207a72", "#b6b3a6"),
        "#657b83", "#148f82", "#d2dae0", "#20252a", "#268bd2",
    )
}
